...
import 'package:fluttermqtt/secrets.dart';
...
class _MQTTClientState extends State<MQTTClient> {
  ...
  final MqttServerClient client =
      MqttServerClient(BROKERURL, 'flutterapp');
      ...
      child: StreamBuilder(
        ...
        builder: (context, snapshot) {
          if (!snapshot.hasData)
            ...
            print("mqtt recived messages ${mqttReceivedMessages![0]}");
  ...
  Future<bool> mqttConnect(String uniqueId) async {
    ...
    final MqttConnectMessage connMess =
        MqttConnectMessage().withClientIdentifier(uniqueId).authenticateAs(USERNAME,PWD).startClean();
    client.connectionMessage = connMess;
    print("Conn message is $connMess");
